...
#pragma region map_unordered_map
	...
	struct map_sample {
		...
		// mapに自作インスタンスを突っ込みたかったら、operatorとかの知識が必須です。
...
#pragma region unique_ptr
	...
	void func4(int placed_size)
	{
		...
		auto p = protected_overflow.get();		// get()するとポインタが取得できるんで。だってunique_ptrの配列はrange-based-forできないんだもん。
...
#pragma region function
	...
	void func5()
	{
		...
		// 関数ファンクタがあったのは、それが一番最適化がかかったからです(それだけじゃないけど無視)。
