...
//      #pragma region～endregion(ソースコードの任意箇所での折り畳み/展開が可能)を使っても良かったのですが、まぁ控えてます。
...
//
// なぜ、多くの場合ヘッダファイルを取り込むかというと、
// C++は文字の入出力などの基本的な機能も標準ライブラリに丸投げし、言語機能としては持っていないからです。
// 何か機能を使いたいと思った時、ヘッダファイルをincludeしないとコンパイラが大抵エラーを出してきます。
...
// 文字列で挿入している関係で関数の実体が複数あることになったりして、コンパイルエラーが多発します。
