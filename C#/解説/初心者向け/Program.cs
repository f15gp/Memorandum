...
//      また、説明なのでコード分析での指摘やクイック操作を完全には除去してません。特にオリジナルはVisual Studio(以降VS) 2015辺りを使って書いたので、
//      VS 2019ではかなり忠告してくれている部分を無視している箇所があります。
...
#if true // 全部出すとコンソール出力が長いので見たいところだけ #if trueにして(#if falseなら#endifまでの内容が無効となる)
