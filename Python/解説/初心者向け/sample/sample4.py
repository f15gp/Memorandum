...
def class_sample5():
    ...
    # なので、多分C#, C++, Javaに頭が凝り固まった人は面食らうと思います。
    # とりあえずオーバーライドするのがPythonにおけるポリモーフィズムな気がします。
    # ま、この辺は言語の文化だからねぇ。
    ...
    # type()を使うと指定インスタンスの型オブジェクトを取得できる。
