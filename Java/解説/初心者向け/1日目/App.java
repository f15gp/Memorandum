...
// Java 6日である程度モダン？なJavaが書けるようになります(Lv5想定)
...
//
// 環境: Windows上で動作確認していて、UTF-8(BOMなし) 行末:CR+LFで書いてます。
//      バージョンは、java 23.0.1 2024-10-15です。
//      エディタでソースを書いて、コマンドで実行する一番基本のやり方を行っています。
//      デバッガも付属のjdbを使ってます。(使ってました。Windowsだとinstallしても見当たらないのでprintlnデバッグしてます)
