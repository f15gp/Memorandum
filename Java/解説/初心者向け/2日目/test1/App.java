...
public class App {
    ...
    static void second() {
        ...
        // でも、それはそれで少し手の混んだことをしようとすると、ハマって涙目になりそうな気も。
        //
        ...
        /* パッケージとコマンドの関係
        先に断っておきますが、最終的なソースの配置は6.のものとなっているため、
        1.からはtreeで表示されるような配置で進んでるんだと思ってください。
        ...
        途中まで実行されるがnew でクラスが見つけれず、java.lang.NoClassDefFoundErrorが発生。
        packageは宣言した階層構造が正しくないといけないため。
